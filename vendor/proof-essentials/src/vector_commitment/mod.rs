...
// `ToBytes` (arkworks 0.3) removed in 0.6; Fiat-Shamir absorption now uses
// `CanonicalSerialize` (serialize_compressed), already required below.
...
pub trait HomomorphicCommitmentScheme<Scalar: Field> {
    type CommitKey: Clone + CanonicalSerialize + CanonicalDeserialize;
